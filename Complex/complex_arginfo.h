 ...
 * Stub hash: d861546a0d61492644ef433ed940ac10368c6d92 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_OceanMoon_Math_Complex_identical, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, other, IS_MIXED, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_OceanMoon_Math_Complex_equal arginfo_class_OceanMoon_Math_Complex_identical
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_OceanMoon_Math_Complex_parse, 0, 1, OceanMoon\\Math\\Complex, 0)
...
ZEND_METHOD(OceanMoon_Math_Complex, identical);
...
ZEND_METHOD(OceanMoon_Math_Complex, parse);
...
static const zend_function_entry class_OceanMoon_Math_Complex_methods[] = {
	...
	ZEND_ME(OceanMoon_Math_Complex, identical, arginfo_class_OceanMoon_Math_Complex_identical, ZEND_ACC_PUBLIC)
	...
	ZEND_ME(OceanMoon_Math_Complex, parse, arginfo_class_OceanMoon_Math_Complex_parse, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
