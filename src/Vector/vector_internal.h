 ...
 * in this directory. Also exposes vector_minit() to ../oceanmoon_math.c, which calls it from the module's
...
/* Module lifecycle hook, called from ../oceanmoon_math.c. See its doc comment in vector.c. */
