 ...
 *
 * rational_minit() is called from the module's real PHP_MINIT_FUNCTION in ../oceanmoon_math.c, which owns
 ...
 * properties are all generated from oceanmoon_math.stub.php into oceanmoon_math_arginfo.h; register them
 * here.
 */
