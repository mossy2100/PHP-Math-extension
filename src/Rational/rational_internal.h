 ...
 * files in this directory. Also exposes rational_minit() to ../oceanmoon_math.c, which calls it from the
...
/* Module lifecycle hook, called from ../oceanmoon_math.c. See its doc comment in rational.c. */
